...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'priority'                    => 'prioridad',
        'region_id'                   => 'región',
        'discount_ranges.0.from_days' => 'período 1 desde',
        'discount_ranges.0.to_days'   => 'período 1 hasta',
        'discount_ranges.0.code'      => 'período 1 código',
        'discount_ranges.0.discount'  => 'período 1 descuento',
        'discount_ranges.1.from_days' => 'período 2 desde',
        'discount_ranges.1.to_days'   => 'período 2 hasta',
        'discount_ranges.1.code'      => 'período 2 código',
        'discount_ranges.1.discount'  => 'período 2 descuento',
        'discount_ranges.2.from_days' => 'período 3 desde',
        'discount_ranges.2.to_days'   => 'período 3 hasta',
        'discount_ranges.2.code'      => 'período 3 código',
        'discount_ranges.2.discount'  => 'período 3 descuento',
